...
public class ExecutionBusinessLogicTest {
    ...
    //private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ExecutionBusinessLogicTest.class);
    ...
    public void testRemovExtraBracketsIfAny() {
        //log.info("testRemovExtraBracketsIfAny");
        final Map<String, String> input = new HashMap<>();
        input.put("idNearRTRIC", "11");
        ...
        try {
            ...
            //log.info("expected: {}", transformedResult1);
            //log.info("actual: {}", executionBusinessLogic.executeTemplate("ran-network", "get-tree", request));
